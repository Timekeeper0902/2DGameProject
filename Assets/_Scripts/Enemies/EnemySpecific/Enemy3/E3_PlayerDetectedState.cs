...
namespace Timekeeper.Enemies.EnemySpecific.Enemy3
{
    public class E3_PlayerDetectedState : PlayerDetectedState
    {
        ...
        public E3_PlayerDetectedState(Entity entity, FiniteStateMachine stateMachine, BaseAudioData baseAudioData, string animBoolName, EnemyBaseData stateData, Enemy3 enemy) : base(entity, stateMachine, baseAudioData, animBoolName, stateData)
        {
            this.enemy = enemy;
        }
